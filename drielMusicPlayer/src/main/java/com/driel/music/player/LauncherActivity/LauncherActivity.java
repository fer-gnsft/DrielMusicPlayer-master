 ...
 */
package com.driel.music.player.LauncherActivity;
...
import com.driel.music.player.Helpers.TypefaceHelper;
import com.driel.music.player.InAppBilling.IabHelper;
import com.driel.music.player.InAppBilling.IabResult;
import com.driel.music.player.InAppBilling.Inventory;
import com.driel.music.player.InAppBilling.Purchase;
import com.driel.music.player.MainActivity.MainActivity;
import com.driel.music.player.MiscFragments.TrialFragment;
import com.driel.music.player.Services.BuildMusicLibraryService;
...
public class LauncherActivity extends FragmentActivity {
    ...
    protected static final String ITEM_SKU = "com.driel.music.player.unlock";
    protected static final String ITEM_SKU_PROMO = "com.driel.music.player.unlock.promo";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (mApp.getSharedPreferences().getBoolean(Common.FIRST_RUN, true)==true) {
	        ...
	        buildingLibraryMainText.setText(R.string.Driel_is_building_library);
	        ...
	        buildingLibraryMainText.setText(R.string.Driel_is_caching_artwork);
	        initScanProcess(0);
	...
	/*IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
		...
		public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
	        ...
	        for (int i=0; i < accounts.length; i++) {
	        	if (accounts[i].name.equals("drielmusicplayer@gmail.com")) {
	 ...
	 * avoid this issue, we'll create a hidden file called ".driel_info" in the user's external
	 ...
	 * 
	 * Every time the app starts up, it will first check for the ".driel_info" file. If it exists,
	...
	/*public void checkTrialStatus() {
		...
		try {
			packageInfo = pm.getPackageInfo("com.driel.music.player", PackageManager.GET_ACTIVITIES);
		...
		if (currentTime >= expiryTime) {
			...
			File file = new File(Environment.getExternalStorageDirectory() + "/.driel_info");
			try {
				if (file.exists()) {
					file.delete();
				}
	...
	/* This method checks for the /sdcard/.driel_info file. If it exists,
