...
import com.driel.music.player.AsyncTasks.AsyncAutoGetAlbumArtTask;
import com.driel.music.player.R;
import com.driel.music.player.SettingsActivity.SettingsActivity____;
...
public class AutoFetchAlbumArtService extends Service {
    ...
    public void onCreate() {
        ...
        sharedPreferences = this.getSharedPreferences("com.driel.music.player", Context.MODE_PRIVATE);
        mContext = this;
        super.onCreate();
