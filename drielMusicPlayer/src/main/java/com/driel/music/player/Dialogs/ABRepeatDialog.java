 ...
 */
package com.driel.music.player.Dialogs;
...
import com.driel.music.player.Views.RangeSeekBar;
import com.driel.music.player.Views.RangeSeekBar.OnRangeSeekBarChangeListener;
...
public class ABRepeatDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		sharedPreferences = getActivity().getSharedPreferences("com.driel.music.player", Context.MODE_PRIVATE);
	...
	public void onStart() {
	    ...
	    LocalBroadcastManager.getInstance(getActivity().getApplicationContext())
	    					 .registerReceiver((receiver), new IntentFilter("com.driel.music.player.UPDATE_NOW_PLAYING"));
