 ...
 */
package com.driel.music.player.BroadcastReceivers;
        ...
        if (mApp.isServiceRunning()) {
            ...
            if (keycode == KeyEvent.KEYCODE_MEDIA_NEXT) {
                ...
                if (action == KeyEvent.ACTION_DOWN) {
                    ...
                    nextIntent.setAction("com.driel.music.player.NEXT_ACTION");
            ...
            if (keycode == KeyEvent.KEYCODE_MEDIA_PREVIOUS) {
                ...
                if (action == KeyEvent.ACTION_DOWN) {
                    ...
                    previousIntent.setAction("com.driel.music.player.PREVIOUS_ACTION");
