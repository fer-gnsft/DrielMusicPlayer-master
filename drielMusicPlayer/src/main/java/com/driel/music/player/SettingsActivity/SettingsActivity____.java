...
import com.driel.music.player.BlacklistManagerActivity.BlacklistManagerActivity;
...
import com.driel.music.player.Services.AutoFetchAlbumArtService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upgradePreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                //initInAppBilling();
                Intent intent = new Intent(mContext, com.driel.music.player.LauncherActivity.LauncherActivity.class);
